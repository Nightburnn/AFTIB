...
const Shortlet = () => {
    ...
    useEffect(() => {
        ...
        const fetchDefaultProperties = async () => {
            try {
                const response = await axios.get(`https://aftib-6o3h.onrender.com/shortlet/getListings/${currentSection}`);
    ...
    const handleSearch = async (e) => {
        ...
        try {
            const response = await axios.get(`https://aftib-6o3h.onrender.com/shortlet/searchListings?location=${location}`);
    ...
    const handleBrowseMore = async () => {
        try {
            ...
            const response = await axios.get(`https://aftib-6o3h.onrender.com/shortlet/getListings/${nextSection}`);
        ...
        <>
            <div className="row list">
                <div className="pListing">
                    <h2>Shortlet Listing</h2>
                    <div className="p-item">
                        <form onSubmit={handleSearch} className="plisting-head me-3">
                            <input
                                type="text"
                                placeholder="Search for shortlet based on location"
                                value={location}
