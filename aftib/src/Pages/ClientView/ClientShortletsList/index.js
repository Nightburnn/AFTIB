    ...
    return (
        <div className="p-3 p-md-5" >
            <div style={{borderRadius: '10px'}} className="py-4 agent my-3">
                ...
                <h3 className="text-center">These are the list of properties you have taken with a shortlet contract.</h3>
            </div>
            <div className="row">
              ...
              <div className="">
                <div className="row">
                  ...
                  <div className="px-3 pb-3">
                    <Link to={`/alrdetails/${listing._id}`} className="btn blue btn-block">View This shortlet</Link>
                  </div>
                  </div>
                </div>
