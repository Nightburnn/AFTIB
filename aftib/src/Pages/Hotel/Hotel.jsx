...
const Hotel = () => {
    ...
    const fetchDefaultHotels = async () => {
      try {
        const response = await axios.get(
          `https://aftib-6o3h.onrender.com/hotel/getListings/${currentSection}`,
        );
  ...
  const handleSearch = async (e) => {
    ...
    try {
      const response = await axios.get(
        `https://aftib-6o3h.onrender.com/hotel/searchListings?location=${location}&checkIn=${checkInDate}&checkOut=${checkOutDate}`,
      );
  ...
  const handleBrowseMore = async () => {
    try {
      ...
      const response = await axios.get(
        `https://aftib-6o3h.onrender.com/hotel/getListings/${nextSection}`,
      );
