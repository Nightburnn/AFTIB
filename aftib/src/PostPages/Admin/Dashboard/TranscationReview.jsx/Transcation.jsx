        ...
        <div key={index} className="transaction-card mb-4 mt-4">
          <div className="p-3">
            ...
            <div className="d-flex justify-content-between mb-2">
              ...
              <span>{transaction.paymentInitialized ? "True" : "False"}</span>
            </div>
          </div>
          ...
          {showDetails && (
            <div className="details-section p-3">
              <div>
                ...
                <p>
                  <strong>Name:</strong> {transaction.agentName}
                </p>
                <p>
                  <strong>Phone:</strong> {transaction.agentPhone}
                </p>
                <p>
                  <strong>Email:</strong> {transaction.agentEmail}
                </p>
              </div>
              <div>
                ...
                <p>
                  <strong>Phone:</strong> {transaction.clientPhone}
                </p>
                <p>
                  <strong>Email:</strong> {transaction.clientEmail}
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>
                  <strong>Name/Title:</strong> {transaction.hotelName}
                </p>
                <p>
                  <strong>Address:</strong> {transaction.hotelAddress}
                </p>
              </div>
            </div>
          )}
