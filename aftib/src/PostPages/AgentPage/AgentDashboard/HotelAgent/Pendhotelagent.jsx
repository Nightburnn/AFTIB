  ...
  return (
    <div className="container hlr mt-3">
      <div className="py-4 agent">
        ...
        <h3 className="text-center">Below are the new listings that need to be reviewed.</h3>
      </div>
          ...
          <div key={hotel._id} className="col-md-4 mb-4">
            <div className="card h-100">
              ...
              <div className="px-3 pb-3">
                <Link to={`/phadetails/${hotel._id}`} className="btn blue btn-block">Review The Hotel</Link>
              </div>
            </div>
          </div>
        ))}
