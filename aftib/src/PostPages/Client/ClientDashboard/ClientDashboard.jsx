            ...
            <div className="col-md-6 mb-4">
                <div className="card text-dark bg-light h-100">
                  <div className="card-body">
                    ...
                    <Link to={'/client/purchaselist'} className="btn blue btn-block mt-3">{'View Your Purchases'}</Link>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-6 mb-4">
                <div className="card text-dark bg-light h-100">
                  <div className="card-body">
                    ...
                    <Link to={'/client/rentallist'} className="btn blue btn-block mt-3">{'View Your Rentals'}</Link>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-6 mb-4">
                <div className="card text-dark bg-light h-100">
                  <div className="card-body">
                    ...
                    <Link to={'/client/hotelreservations'} className="btn blue btn-block mt-3">{'View Your Reservations'}</Link>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-6 mb-4">
                <div className="card text-dark bg-light h-100">
                  <div className="card-body">
                    ...
                    <Link to={'/client/shortletlist'} className="btn blue btn-block mt-3">{'View Your Shortlets'}</Link>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-6 mb-4">
                <div className="card text-dark bg-light h-100">
                  <div className="card-body">
                    ...
                    <Link to={'/client/transactionslist'} className="btn blue btn-block mt-3">{'View Your Transactions'}</Link>
                  </div>
                </div>
              </div>
            </div>
